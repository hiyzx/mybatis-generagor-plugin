 ...
 */
public class CommentWithoutSwaggerPlugin extends PluginAdapter {
    private static final Logger LOG = LoggerFactory.getLogger(CommentWithoutSwaggerPlugin.class);
